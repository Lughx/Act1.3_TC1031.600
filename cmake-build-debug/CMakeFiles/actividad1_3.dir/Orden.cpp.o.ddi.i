# 0 "/home/lughx/CLionProjects/actividad1.3/Orden.cpp"
# 1 "/home/lughx/CLionProjects/actividad1.3/cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/lughx/CLionProjects/actividad1.3/Orden.cpp"
# 1 "/home/lughx/CLionProjects/actividad1.3/Orden.h" 1
...
# 61 "/usr/include/c++/14.2.1/vector" 2 3
...
# 63 "/usr/include/c++/14.2.1/vector" 2 3
...
# 3 "/home/lughx/CLionProjects/actividad1.3/Orden.h" 2
...
# 47 "/usr/include/c++/14.2.1/bits/basic_string.h" 3
...
# 4 "/home/lughx/CLionProjects/actividad1.3/Orden.h" 2

# 4 "/home/lughx/CLionProjects/actividad1.3/Orden.h"
using namespace std;

class Orden
{
public:
 static void quickSort(vector<vector<string>>, int , int );
private:
 static void swap(int*, int*);
 static int partition(vector<vector<string>>, int, int);
};
# 2 "/home/lughx/CLionProjects/actividad1.3/Orden.cpp" 2




void Orden::quickSort(vector<vector<string>> arr, int low, int high)
{
 if (low < high)
 {
...
int Orden::partition(vector<vector<string>> arr, int low, int high)
{
 int pivot = stoi(arr[high][1]);
 int i = (low - 1);
 ...
 for (int j = low; j <= high - 1; j++)
 {
  ...
  if (stoi(arr[j][1]) <= pivot)
  {
   i++;
   swap(&stoi(arr[i][1]), &stoi(arr[j][1]));
  }
 }
